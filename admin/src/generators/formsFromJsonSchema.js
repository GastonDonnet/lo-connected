...
const main = async () => {
  const models = fs.readdirSync('C:/Users/Gaston/Documents/GitHub/LoConected/server/models');
  ...
  for (modelName of models) {
    ...
    const model = require(`C:/Users/Gaston/Documents/GitHub/LoConected/server/models/${modelName}`);
